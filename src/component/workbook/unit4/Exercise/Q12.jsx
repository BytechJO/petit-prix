...
const WORDS = [
    ...
    { id: 'word-4', text: 'Antoine', correctMatch: 'img-4', bg: '#d2232a' },
    { id: 'word-5', text: 'Eloise', correctMatch: 'img-5', bg: '#00aeef' },
    { id: 'word-6', text: 'Anna', correctMatch: 'img-6', bg: '#ec008c' },
]
...
const img4 = '/assets/unit3/review/page39/01.svg';
const img5 = '/assets/unit3/review/page39/02.svg';
const img6 = '/assets/unit3/review/page39/03.svg';

const IMAGES = [
    { id: 'img-1', src: img1, alt: 'Super' },
    { id: 'img-2', src: img2, alt: 'Comme ci comme ça' },
    { id: 'img-3', src: img3, alt: 'Bien' },
    { id: 'img-4', src: img4, alt: 'Super' },
    { id: 'img-5', src: img5, alt: 'Comme ci comme ça' },
    { id: 'img-6', src: img6, alt: 'Bien' },
]
                ...
                <div className="flex justify-around mb-16">
                    {WORDS.map((word) => (
                        <div
                            ...
                            className="p-4 rounded-lg shadow-sm cursor-pointer text-center"
                            style={{ backgroundColor: word.bg }}
                        >
                            <span className="font-semibold text-white text-xl">{word.text}</span>
                        </div>
                    ))}
                </div>
