...
const img1 = '/assets/workbook/unit1/page8/01.svg';
const img2 = '/assets/workbook/unit1/page8/02.svg';
const img3 = '/assets/workbook/unit1/page8/03.svg';
const img4 = '/assets/workbook/unit1/page8/04.svg';

const wordsData = [
    { image: img1, isFrench: false, font: "'Pacifico', cursive" },
    { image: img2, isFrench: false, font: "'Roboto', sans-serif" },
    { image: img3, isFrench: true, font: "'Caveat', cursive" },
    { image: img4, isFrench: false, font: "'Noto Kufi Arabic', sans-serif" },
        ...
        <div className="w-full max-w-2xl mx-auto p-8 bg-sky-50 rounded-2xl shadow-lg mt-7">
            ...
            <div className="flex flex-wrap justify-center items-center gap-5 p-8 min-h-[400px]">
                ...
                <div className="flex items-center gap-2">
                    <span className='font-bold'>Ça va</span>
                    <input
                        type="text"
                        className="bg-white w-60 h-12 text-center rounded-lg font-bold text-xl border border-gray-300"
                    />
